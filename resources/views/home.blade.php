...
<div class="h-screen relative top-10">
    ...
    @endif
    <div style="box-shadow: 0px -5px 10px rgb(17 24 39);" class="z-10 absolute bg-gray-900 w-screen h-24 bottom-20 sm:left-0 md:h-40 md:w-1/2 md:bottom-0 md:right-0"></div>
